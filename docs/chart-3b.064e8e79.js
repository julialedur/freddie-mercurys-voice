...
function ready(datapoints) {
  ...
  function clickButton() {
    ...
    buttons.forEach(function (song_button) {
      ...
      var song_button_id = song_button.id; // should do a wait before this ting plays
    ...
    function songButtonPressed(song_button_id) {
      var song = loadSongByButtonID(song_button_id);
      playSong(song);
      animateSVG();
    } // load songs
    ...
    function loadSongByButtonID(song_button_id) {
      var songID = 'song_' + song_button_id;
      console.log(songID);
...
//# sourceMappingURL=/freddie-mercurys-voice/chart-3b.6b959217.map