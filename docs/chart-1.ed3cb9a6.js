...
},{"d3-path":"9OTy","./constant":"ez+x","./math":"kIKs"}],"+L3Q":[function(require,module,exports) {
"use strict";
...
},{"d3-path":"9OTy","./constant":"ez+x","./curve/linear":"+L3Q","./point":"LnI9"}],"IYvJ":[function(require,module,exports) {
"use strict";
...
},{"d3-path":"9OTy","./constant":"ez+x","./curve/linear":"+L3Q","./line":"KhHE","./point":"LnI9"}],"idkR":[function(require,module,exports) {
"use strict";
...
},{"./constant":"ez+x","./descending":"fBAz","./identity":"idkR","./math":"kIKs"}],"LARK":[function(require,module,exports) {
"use strict";
...
},{"d3-path":"9OTy","../array":"KXlw","../constant":"ez+x","../point":"LnI9","../pointRadial":"vzjT"}],"zjv7":[function(require,module,exports) {
"use strict";
...
},{"d3-path":"9OTy","./symbol/circle":"zjv7","./symbol/cross":"PTh9","./symbol/diamond":"08fu","./symbol/star":"L5Ql","./symbol/square":"bj9s","./symbol/triangle":"owZx","./symbol/wye":"UZQY","./constant":"ez+x"}],"cx05":[function(require,module,exports) {
"use strict";
...
},{"./array":"KXlw","./constant":"ez+x","./offset/none":"jW6Y","./order/none":"NTwk"}],"WOsM":[function(require,module,exports) {
"use strict";
...
},{"./dist/package":"pT13","d3-array":"K0bd","d3-axis":"mp0m","d3-brush":"tkh5","d3-chord":"Iy8J","d3-collection":"S3hn","d3-color":"Peej","d3-contour":"5SiB","d3-dispatch":"D3zY","d3-drag":"kkdU","d3-dsv":"EC2w","d3-ease":"pJ11","d3-fetch":"grWT","d3-force":"oYRE","d3-format":"VuZR","d3-geo":"/Ah6","d3-hierarchy":"Kps6","d3-interpolate":"k9aH","d3-path":"9OTy","d3-polygon":"H15P","d3-quadtree":"lUbg","d3-random":"Gz2j","d3-scale":"zL2z","d3-scale-chromatic":"1ado","d3-selection":"//ys","d3-shape":"9maw","d3-time":"0hQY","d3-time-format":"UYpZ","d3-timer":"rdzS","d3-transition":"UqVV","d3-voronoi":"rLIC","d3-zoom":"MHdZ"}],"4qT6":[function(require,module,exports) {
"use strict";

module.exports = "/freddie-mercurys-voice/all_songs.ebca8fab.csv";
},{}],"9VpW":[function(require,module,exports) {
"use strict";

module.exports = "/freddie-mercurys-voice/points.60317af4.csv";
},{}],"HpJq":[function(require,module,exports) {
"use strict";

module.exports = "/freddie-mercurys-voice/face.12d6f94c.csv";
},{}],"HNc5":[function(require,module,exports) {
"use strict";

module.exports = "/freddie-mercurys-voice/piano.aefc295c.csv";
},{}],"sHHT":[function(require,module,exports) {
"use strict";

module.exports = "/freddie-mercurys-voice/note.e009a8d4.csv";
},{}],"kxuN":[function(require,module,exports) {
"use strict";

module.exports = "/freddie-mercurys-voice/mag-glass.34d16c17.csv";
},{}],"Uc75":[function(require,module,exports) {
"use strict";
...
var xPositionScale = d3.scaleLinear().range([0, width]).domain([0, 200]);
var yPositionScale = d3.scaleLinear().range([height, 0]).domain([0, 100]);
var colorScale = d3.scaleLinear().domain([0, 100]).range(['#FFC75C', '#FA0DE5']);
Promise.all([d3.csv(require('./data/all_songs.csv')), d3.csv(require('./data/points.csv')), d3.csv(require('./data/face.csv')), d3.csv(require('./data/piano.csv')), d3.csv(require('./data/note.csv')), d3.csv(require('./data/mag-glass.csv'))]).then(ready).catch(function (err) {
...
function ready(_ref) {
  var _ref2 = _slicedToArray(_ref, 6),
      datapoints = _ref2[0],
      coordinates = _ref2[1],
      faceCoordinates = _ref2[2],
      pianoCoordinates = _ref2[3],
      noteCoordinates = _ref2[4],
      magGlassCoordinates = _ref2[5];
  ...
  svg.selectAll('circle').data(datapoints).enter().append('circle').attr('r', 1).attr('fill', '#FA0DE5').attr('cx', function (d) {
    return d.faceX;
  }).attr('cy', function (d) {
    return d.faceY;
  });
  d3.select('#blank').on('stepin', function () {
    svg.selectAll('circle').transition().duration(500).ease(d3.easeBack).attr('r', 2).attr('cx', function (d) {
      return d.faceX;
    }).attr('cy', function (d) {
      return d.faceY;
    });
  });
  d3.select('#freddie').on('stepin', function () {
    svg.selectAll('circle').transition().duration(500).ease(d3.easeBack).attr('r', 2).attr('cx', function (d) {
      return d.faceX;
    }).attr('cy', function (d) {
      return d.faceY;
  ...
  d3.select('#piano-dots').on('stepin', function () {
    svg.selectAll('circle').transition().duration(500).ease(d3.easeBack).attr('r', 2).attr('cx', function (d) {
      return d.pianoX;
    }).attr('cy', function (d) {
      return d.pianoY;
  ...
  d3.select('#note').on('stepin', function () {
    svg.selectAll('circle').transition().duration(1000).ease(d3.easeBack).attr('r', 2).attr('cx', function (d) {
      return d.noteX;
    }).attr('cy', function (d) {
      return d.noteY;
    });
  });
  d3.select('#glass').on('stepin', function () {
    svg.selectAll('circle').transition().duration(1000).ease(d3.easeBack).attr('r', 2).attr('cx', function (d) {
      return d.glassX;
    }).attr('cy', function (d) {
      return d.glassY;
...
},{"d3":"UzF0","./data/all_songs.csv":"4qT6","./data/points.csv":"9VpW","./data/face.csv":"HpJq","./data/piano.csv":"HNc5","./data/note.csv":"sHHT","./data/mag-glass.csv":"kxuN"}]},{},["Uc75"], null)
//# sourceMappingURL=/freddie-mercurys-voice/chart-1.61546079.map